        ...
        <section id="home" className="hero relative overflow-hidden min-h-screen flex items-center">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
            ...
            {/* Title */}
                   <h1
                     ref={titleRef}
                     className={`hero-title mt-4 text-5xl sm:text-6xl lg:text-7xl leading-tight font-medium tracking-tight transition-all duration-600 ${
            ...
            <p
              ref={subtitleRef}
              className={`subtitle mt-6 text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto transition-all duration-600 ${
